...
export default function RenterPanel({ equipments, loading, onDeposit, onEndRental }) {
    ...
    const handleReturn = async (rentalId) => {
        setActionLoading(rentalId);
        try {
            await onEndRental(rentalId, false); // Normal iade
        } catch (err) {
            console.error(err);
        }
        setActionLoading(null);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="glass p-6">
                ...
                {/* Gizli dosya input'u — fotoğraf yükleme */}
                <input
                    ref={fileInputRef}
                    type="file"
                    accept="image/*"
